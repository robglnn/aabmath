...
export function buildWorldSites(scene: THREE.Scene): WorldSite[] {
  ...
  const board19 = createLessonBoard()
  placeOnGround(board19, -28, 18)
  board19.rotation.y = -1.1
  scene.add(board19)
  sites.push({
    siteId: 'lesson_board_19',
    mesh: board19,
    position: board19.position.clone(),
    interactRadius: 4,
  })

  const board20 = createLessonBoard()
  placeOnGround(board20, 22, -28)
  board20.rotation.y = 0.4
  scene.add(board20)
  sites.push({
    siteId: 'lesson_board_20',
    mesh: board20,
    position: board20.position.clone(),
    interactRadius: 4,
  })

  const board21 = createLessonBoard()
  placeOnGround(board21, -12, 30)
  board21.rotation.y = 2.0
  scene.add(board21)
  sites.push({
    siteId: 'lesson_board_21',
    mesh: board21,
    position: board21.position.clone(),
    interactRadius: 4,
  })

  const board22 = createLessonBoard()
  placeOnGround(board22, 30, 12)
  board22.rotation.y = -0.6
  scene.add(board22)
  sites.push({
    siteId: 'lesson_board_22',
    mesh: board22,
    position: board22.position.clone(),
    interactRadius: 4,
  })

  const board23 = createLessonBoard()
  placeOnGround(board23, -30, -16)
  board23.rotation.y = 1.0
  scene.add(board23)
  sites.push({
    siteId: 'lesson_board_23',
    mesh: board23,
    position: board23.position.clone(),
    interactRadius: 4,
  })

  const board24 = createLessonBoard()
  placeOnGround(board24, 16, 32)
  board24.rotation.y = -2.2
  scene.add(board24)
  sites.push({
    siteId: 'lesson_board_24',
    mesh: board24,
    position: board24.position.clone(),
    interactRadius: 4,
  })

  const board25 = createLessonBoard()
  placeOnGround(board25, -16, 36)
  board25.rotation.y = 0.55
  scene.add(board25)
  sites.push({
    siteId: 'lesson_board_25',
    mesh: board25,
    position: board25.position.clone(),
    interactRadius: 4,
  })

  const board26 = createLessonBoard()
  placeOnGround(board26, 32, -30)
  board26.rotation.y = -1.4
  scene.add(board26)
  sites.push({
    siteId: 'lesson_board_26',
    mesh: board26,
    position: board26.position.clone(),
    interactRadius: 4,
  })

  const board27 = createLessonBoard()
  placeOnGround(board27, -34, 8)
  board27.rotation.y = 1.7
  scene.add(board27)
  sites.push({
    siteId: 'lesson_board_27',
    mesh: board27,
    position: board27.position.clone(),
    interactRadius: 4,
  })

  const board28 = createLessonBoard()
  placeOnGround(board28, 8, 38)
  board28.rotation.y = 2.1
  scene.add(board28)
  sites.push({
    siteId: 'lesson_board_28',
    mesh: board28,
    position: board28.position.clone(),
    interactRadius: 4,
  })

  const board29 = createLessonBoard()
  placeOnGround(board29, -36, -24)
  board29.rotation.y = -0.8
  scene.add(board29)
  sites.push({
    siteId: 'lesson_board_29',
    mesh: board29,
    position: board29.position.clone(),
    interactRadius: 4,
  })

  const board30 = createLessonBoard()
  placeOnGround(board30, 36, 18)
  board30.rotation.y = 1.3
  scene.add(board30)
  sites.push({
    siteId: 'lesson_board_30',
    mesh: board30,
    position: board30.position.clone(),
    interactRadius: 4,
  })
